...
import { WarnBadge } from 'components/atoms/Badge'
              ...
              <React.Fragment>
                     <div className="mt-10">
                            <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                                   ...
                                   <h1 className="font-normal text-xs md:text-sm text-yellow-400">{startDate} - {endDate}</h1>
                            </div>
                            <h1 className="font-medium text-lg text-yellow-400 mt-4 md:mt-2">{company} <WarnBadge>{duration} Month</WarnBadge></h1>
